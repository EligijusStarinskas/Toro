...
public class MatrixManager {
	...
	@NonNull protected                      Point     intrinsicVideoSize = new Point(0, 0);
	@IntRange(from = 0, to = 359) protected int       currentRotation    = 0;
	@NonNull protected                      ScaleType currentScaleType   = ScaleType.FIT_CENTER;

	@Nullable protected Integer                    requestedRotation         = null;
	@Nullable protected ScaleType                  requestedScaleType        = null;
	@NonNull protected  WeakReference<TextureView> requestedModificationView = new WeakReference<>(null);
	...
	public void setIntrinsicVideoSize(@IntRange(from = 0) int width, @IntRange(from = 0) int height) {
		...
		intrinsicVideoSize.x = currentWidthHeightSwapped
		                       ? height
		                       : width;
		intrinsicVideoSize.y = currentWidthHeightSwapped
		                       ? width
		                       : height;
	...
	public int getCurrentRotation() {
		return requestedRotation != null
		       ? requestedRotation
		       : currentRotation;
	}

	@NonNull public ScaleType getCurrentScaleType() {
		return requestedScaleType != null
		       ? requestedScaleType
		       : currentScaleType;
	}
